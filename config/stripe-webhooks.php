...
return [
     ...
     */
    'jobs' => [
        // 'payment_intent_succeeded' => \App\Jobs\StripeWebhooks\PaymentSucceededJob::class,
        // 'checkout_session_async_payment_succeeded'=> \App\Jobs\StripeWebhooks\PaymentSucceededJob::class,
        'checkout_session_completed'=> \App\Jobs\StripeWebhooks\PaymentSucceededJob::class,
        // 'invoice_payment_succeeded'=> \App\Jobs\StripeWebhooks\PaymentSucceededJob::class,
        // 'checkout.session.async_payment_succeeded' => \App\Jobs\StripeWebhooks\PaymentSucceededJob::class,
